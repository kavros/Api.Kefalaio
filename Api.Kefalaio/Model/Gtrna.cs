...
{
    [Table("GTRNA")]
    [Index(nameof(GtDocNum), nameof(GtLine), Name = "gtoByDoc")]
    [Index(nameof(GtJournalId), nameof(GtTransNum), nameof(GtDate), nameof(GtLine), Name = "gtoByJournalId")]
    [Index(nameof(GtrFromFile), nameof(GtrOrigin), Name = "gtoByOrigin")]
    [Index(nameof(GtTransId), nameof(GtLine), Name = "gtoByTransId")]
    [Index(nameof(GmFileId), nameof(GtDate), Name = "gtoBygmFileId")]
    [Index(nameof(GtDate), nameof(GtGroupNo), nameof(GtLine), Name = "gtoBygtDate", IsUnique = true)]
    public partial class Gtrna
    {
        public Gtrna()
        {
        ...
        [InverseProperty(nameof(Gmastum.Gtrnas))]
        public virtual Gmastum GmFile { get; set; }
        [ForeignKey(nameof(GtTransKind))]
        [InverseProperty(nameof(Gltrndesc.Gtrnas))]
        public virtual Gltrndesc GtTransKindNavigation { get; set; }
        [InverseProperty(nameof(Extext.GtFileIdOldNavigation))]
