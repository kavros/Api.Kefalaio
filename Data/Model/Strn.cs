...
{
    [Table("STRN")]
    [Index(nameof(StDate), nameof(SFileId), nameof(StInsDate), nameof(StTime), Name = "stByDate")]
    [Index(nameof(StDocOrigin), nameof(StDocLine), Name = "stByDocOrigin")]
    [Index(nameof(StSetGroupPos), Name = "stByGroupPos")]
    [Index(nameof(SFileId), nameof(StDate), nameof(StInsDate), nameof(StTime), Name = "stByItem")]
    [Index(nameof(SFileId), nameof(StLocation), nameof(StDate), nameof(StInsDate), nameof(StTime), Name = "stByItemAX")]
    [Index(nameof(StSetGroupVm1), nameof(StDocLine), Name = "stByVM1Group")]
    public partial class Strn
    {
        public Strn()
        {
        ...
        [InverseProperty(nameof(Smast.Strns))]
        public virtual Smast SFile { get; set; }
        [ForeignKey(nameof(StBm1origin))]
        [InverseProperty(nameof(Bmast1.Strns))]
        public virtual Bmast1 StBm1originNavigation { get; set; }
        [ForeignKey(nameof(StLocation))]
        [InverseProperty(nameof(Stockspace.Strns))]
        public virtual Stockspace StLocationNavigation { get; set; }
        [ForeignKey(nameof(StNmCostOrigin))]
        [InverseProperty(nameof(Nmcost.Strns))]
        public virtual Nmcost StNmCostOriginNavigation { get; set; }
        [ForeignKey(nameof(StNmSpInvOrigin))]
        [InverseProperty(nameof(Nspminv.Strns))]
        public virtual Nspminv StNmSpInvOriginNavigation { get; set; }
        [ForeignKey(nameof(StTransKind))]
        [InverseProperty(nameof(Stortrndesc.Strns))]
        public virtual Stortrndesc StTransKindNavigation { get; set; }
        [ForeignKey(nameof(StVatid))]
        [InverseProperty(nameof(Vat.Strns))]
        public virtual Vat StVat { get; set; }
        [ForeignKey(nameof(StVm1origin))]
        [InverseProperty(nameof(Vmast1.Strns))]
        public virtual Vmast1 StVm1originNavigation { get; set; }
        [InverseProperty(nameof(Extext.StFile))]
