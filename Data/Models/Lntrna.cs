...
{
    [Table("LNTRNA")]
    [Index(nameof(Ltdate), nameof(Insdate), nameof(Lttime), Name = "LtoByltDate")]
    [Index(nameof(Ltmpos), nameof(Ltdate), nameof(Insdate), nameof(Lttime), Name = "ltoByLmFileId1")]
    [Index(nameof(Ltmpos), nameof(Ltbuyid), nameof(Ltdate), nameof(Ltdateid), Name = "ltoByLmFileId2")]
    [Index(nameof(Ltmpos), nameof(Ltbuyid), nameof(Ltdate), nameof(Ltkind), Name = "ltoByLmFileId3")]
    [Index(nameof(Ltmpos), nameof(Ltdate), nameof(Ltdateid), Name = "ltoByLmFileId4")]
    public partial class Lntrna
    {
        public Lntrna()
        {
        ...
        [InverseProperty(nameof(Assettrndesc.Lntrnas))]
        public virtual Assettrndesc LtkindNavigation { get; set; }
        [ForeignKey(nameof(Ltmpos))]
        [InverseProperty(nameof(Lnmastum.Lntrnas))]
        public virtual Lnmastum LtmposNavigation { get; set; }
        [InverseProperty(nameof(Extext.LtFileIdOldNavigation))]
