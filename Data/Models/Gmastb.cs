...
{
    [Table("GMASTB")]
    [Index(nameof(GCode), Name = "gByCode", IsUnique = true)]
    [Index(nameof(GMother), Name = "gByMother")]
    [Index(nameof(GNameSrt), Name = "gByName")]
    [Index(nameof(GVatno), nameof(GCountry), Name = "gByVatNo")]
    public partial class Gmastb
    {
        public Gmastb()
        {
        ...
        [InverseProperty(nameof(Extext.GFile))]
        public virtual ICollection<Extext> Extexts { get; set; }
        [InverseProperty(nameof(Gtrnb.GmFile))]
