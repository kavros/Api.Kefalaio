...
{
    [Table("LNMASTA")]
    [Index(nameof(LCode), Name = "LnoBylCode", IsUnique = true)]
    [Index(nameof(LNameSrt), Name = "LnoBylName")]
    [Index(nameof(LConnect), Name = "LnoByllConnect")]
    public partial class Lnmastum
    {
        public Lnmastum()
        {
        ...
        [InverseProperty(nameof(Extext.LFileIdOldNavigation))]
        public virtual ICollection<Extext> Extexts { get; set; }
        [InverseProperty(nameof(Lntrna.LtmposNavigation))]
